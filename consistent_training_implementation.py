...
def train_simpson_consistent(model, data, z_grid, epochs=10000, lr=0.01, T=10.0, eps=1e-5, device='cuda',
...
def run_consistent_experiment():
    ...
    loss_history, trained_model, A_diff_history = train_simpson_consistent(
        model, data, z_grid, lr=0.01, T=T, device=device, 
