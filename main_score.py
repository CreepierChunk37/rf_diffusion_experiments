...
from data_generation_score import generate_data_samples, compute_UV_unweighted
from gradient_flow import compute_A_infty
from sde_simulation_score import simulate_reverse_sde
...
def main():
    ...
    if snapshots:
        ...
        start_time = time.time()
        plot_snapshots(snapshots, "SDE Evolution Snapshots", m_z=m_z, script_source="main_score.py")
